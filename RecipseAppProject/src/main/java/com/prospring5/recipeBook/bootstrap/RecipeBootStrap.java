package com.prospring5.recipeBook.bootstrap;
...
import com.prospring5.recipeBook.model.Difficulty;
import com.prospring5.recipeBook.model.Ingredient;
import com.prospring5.recipeBook.model.Notes;
import com.prospring5.recipeBook.model.Recipe;
import com.prospring5.recipeBook.model.UnitOfMeasure;
import com.prospring5.recipeBook.repositories.CategoryRepository;
import com.prospring5.recipeBook.repositories.RecipeRepository;
import com.prospring5.recipeBook.repositories.UnitOfMeasureRepository;
...
public class RecipeBootStrap implements ApplicationListener<ContextRefreshedEvent>
{
	...
	private List<Recipe> getRecipes() {
		log.debug("Method  getRecipes started in RecipeBootStrap");
        ...
        guacNotes.setRecipeNotes("For a very quick guacamole just take a 1/4 cup of salsa and mix it in with your mashed avocados.\n" +
                ...
                "\n" +
                "\n" +
                "Read more: http://www.simplyrecipes.com/recipeList/perfect_guacamole/#ixzz4jvoun5ws");
        guacNotes.setRecpies(guacRecipe);
        ...
        tacoNotes.setRecpies(tacosRecipe);
		...
		log.debug("Method  getRecipes ended in RecipeBootStrap");
